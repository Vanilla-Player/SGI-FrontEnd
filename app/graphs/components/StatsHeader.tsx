...
export default function StatsHeader() {
  const stats = [
    { name: "Demanda promedio mensual  ", value: "203" },
    {
      name: "Desviacion estandar de la demanda",
      value: "3.65",
      unit: "",
    },
    { name: "Porcentaje de participacion por categoria", value: "3" },
    { name: "Tasa de crecimiento de la demanda", value: "0.05%" },
  ];
  return (
